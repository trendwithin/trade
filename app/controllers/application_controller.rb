class ApplicationController < ActionController::Base
  ...
  protected
    ...
    def configure_parameter_sanitizer
      ...
      devise_parameter_sanitizer.for(:account_update) { |u| u.permit(:username, :bio, :first_name, :last_name, :location, :website, :password, :password_confirmation, :current_password) }
    end
end
